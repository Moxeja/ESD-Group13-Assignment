 ...
 * @author Tom
 */
public class DestroyAppointmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("delete")!= null){
            ...
            manageAppointment.destroyOldAppointment(SID);
        }
        
        RequestDispatcher rd = request.getRequestDispatcher("/views/manage-appointments-page.jsp");
